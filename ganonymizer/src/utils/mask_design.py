...
def create_boxline(mask, obj_rec, width, original):
    ...
    cv2.imwrite('./ganonymizer/data/images/for_seg_bbox/boxline_od.png', boxline)
    cv2.imwrite('./ganonymizer/data/images/for_seg_bbox/mask_od.png', mask)
    cv2.imwrite('./ganonymizer/data/images/for_seg_bbox/boxline-mask_od.png', boxline - mask)
    return boxline - mask
