...
parser.add_argument('--prototxt', default='./cfgs/MobileNetSSD_deploy.prototxt.txt', help='path to Caffe deploy prototxt file')
parser.add_argument('--model', default='./cfgs/MobileNetSSD_deploy.caffemodel', help='path to Caffe pre-trained file')
...
if __name__ == '__main__':
    ...
    outfile = '{}out4_{}'.format(file_dir, file_name)
    fps = 20.0
    codecs = 'H264'
